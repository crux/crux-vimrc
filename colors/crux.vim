" ----------------------------------------------------------------------------
" Vim color file
" Maintainer:   Dirk Lüsebrink (cloned from: John-Paul Bader <contact@smyck.org>)
" Last Change:  2017 Feb
" License:      Whatever
" ----------------------------------------------------------------------------
...
hi Search               cterm=none ctermbg=4        ctermfg=0       gui=none        guibg=#2EB5C1   guifg=#F7F7F7
...
hi Comment              cterm=none ctermbg=none ctermfg=5           gui=none        guifg=#8F8F8F
